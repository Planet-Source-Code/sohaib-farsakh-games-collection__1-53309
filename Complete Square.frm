...
Dim turn As String
Dim grid(7, 7) As Integer
Dim grid2(7, 7) As Integer
Dim recentwin As Boolean
Dim winned As Integer
Dim lbl2(55) As Boolean
Dim lbl3(55) As Boolean
...
Else
Label3(lastblue - 56).BackColor = vbBlue
End If
Case "red"
If lastred < 56 Then
Label2(lastred).BackColor = vbRed
Else
Label3(lastred - 56).BackColor = vbRed
End If
End Select
End Sub
Sub Delay(secs)
...
a = Int(Label2(indexx).index / 7) + 1
b = (Label2(indexx).index Mod 7) + 1
If a > 1 Then
...
a = Int(Label3(indexx).index / 8) + 1
b = (Label3(indexx).index Mod 8) + 1
If b > 1 Then
...
End If
If Label2(b).Enabled = True And i < 7 Then
grid2(i + 1, j) = grid2(i + 1, j) + 1
End If
If Label3(c).Enabled = True And j > 1 Then
grid2(i, j - 1) = grid2(i, j - 1) + 1
End If
If Label3(d).Enabled = True And j < 7 Then
grid2(i, j + 1) = grid2(i, j + 1) + 1
End If
End If
Next j
...
Else
Label3(e - 56).BackColor = vbbrown
Delay (0.5)
Label3(e - 56).BackColor = &HC000&
End If
...
For i = 1 To 7
    For j = 1 To 7
        ...
        End Select
        Shape1(winned).Top = 1200 + (i - 1) * 720
        Shape1(winned).Left = 650 + (j - 1) * 960
        If Val(Label5.Caption) + Val(Label7.Caption) = 49 Then
        endgame
        End If
        End If
    Next j
